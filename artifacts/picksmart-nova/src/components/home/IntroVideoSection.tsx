...
const CARD_HREFS = ["/training", "/training", "/progress"];

export default function IntroVideoSection() {
  const { t } = useTranslation();
  const cards = t("home.introVideo.cards", { returnObjects: true }) as Array<{
    title: string;
    text: string;
    buttonText: string;
  }>;
  ...
  return (
    <section className="py-20 bg-slate-950">
      <div className="max-w-7xl mx-auto px-6">
        <SectionHeading
          eyebrow={t("home.introVideo.eyebrow")}
          title={t("home.introVideo.title")}
          subtitle={t("home.introVideo.subtitle")}
        />
