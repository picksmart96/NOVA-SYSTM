    ...
    return (
      <div className="min-h-screen bg-slate-950 text-white flex items-center justify-center">
        <div className="text-center space-y-3">
          ...
          <h2 className="text-2xl font-black">Company Plan Active!</h2>
    ...
    <div className="min-h-screen bg-slate-950 text-white px-6 py-16">
      <div className="max-w-xl mx-auto">
        <div className="rounded-3xl border border-yellow-400 bg-slate-900 p-8 shadow-xl">
          ...
          <h1 className="mt-3 text-3xl font-black">Company Plan Checkout</h1>
          <p className="mt-2 text-slate-400">Team and warehouse operations access.</p>
          ...
          <div className="mt-8 rounded-2xl border border-slate-800 bg-slate-950 p-5 space-y-2">
            ...
            {["Everything in Personal", "Trainer Dashboard", "Supervisor Dashboard", "Team workflow access", "Assignment management", "Live tracking"].map((f) => (
          ...
          <p className="mt-4 text-xs text-red-400">
            Users & Access and Owner controls remain owner-only regardless of plan.
          </p>

          <div className="mt-4 rounded-2xl border border-slate-800 bg-slate-950 px-5 py-4 flex justify-between items-center">
            <span className="text-slate-400 text-sm">Plan</span>
            <span className="font-black text-white">Company</span>
          </div>

          {!currentUser && (
            <p className="mt-4 text-sm text-amber-400">
              You need to be signed in to subscribe.{" "}
              <button onClick={() => navigate("/login?redirect=/checkout/company")} className="underline">Sign in</button>
            </p>
          )}
